...
function start() {
    ...
    const dataUri = `https://s3-use1-ap-pe-products-client-europa-website-d.s3.amazonaws.com/test/abc.txt`
    ...
    msgCard.addSection({
        ...
        markdown: true,
        text: `<div><h2><a href="${dataUri}">abc(S3 public link)</a></h2></div>`
    });
